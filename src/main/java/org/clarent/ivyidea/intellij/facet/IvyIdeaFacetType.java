...
public class IvyIdeaFacetType extends FacetType<IvyIdeaFacet, IvyIdeaFacetConfiguration> {
    private static final String FACET_NAME = "IvyIDEA";
    public static final FacetTypeId<IvyIdeaFacet> ID = new FacetTypeId<>(FACET_NAME);
    ...
    public IvyIdeaFacetType() {
        super(ID, FACET_NAME, FACET_NAME);
    }
    ...
    @Override
    public IvyIdeaFacet createFacet(@NotNull Module module, String name, @NotNull IvyIdeaFacetConfiguration configuration, @Nullable Facet facet) {
        return new IvyIdeaFacet(this, module, name, configuration, facet);
    }
