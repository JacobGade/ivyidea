 ...
 */
@Service
@State(name = IvyIdeaProjectConfigurationService.COMPONENT_NAME, storages = {@Storage("$PROJECT_FILE$")})
public final class IvyIdeaProjectConfigurationService implements PersistentStateComponent<IvyIdeaProjectSettings> {

    public static final String COMPONENT_NAME = "IvyIDEA.ProjectSettings";

    private final IvyIdeaProjectSettings internalState;

    public IvyIdeaProjectConfigurationService() {
